...
slug: "build-benchmarks/explanation/get-right-questions.html"
...
- For full option details and validation rules, see [Generation Configuration Reference](/../reference/generate-config).

- For allowed Hugging Face benchmarks and subsets, see [Supported Hugging Face Benchmarks](/../reference/benchmarks).

- For how the prepare step uses this mapping to build the seed dataset, see [Data Preparation for Multiple-Choice Question Benchmarks](/data-preparation).
