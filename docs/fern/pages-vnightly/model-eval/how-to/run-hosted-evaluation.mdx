...
slug: "model-eval/how-to/run-hosted-evaluation.html"
...
- [Discover The Model Evaluation Step](/discover-the-step) for discovery commands.

- [Evaluate A Deployed Checkpoint](/evaluate-deployed-checkpoint) for the launcher-managed checkpoint path.

- [CLI Reference](/../reference/cli-reference) for the full flag and override surface.
