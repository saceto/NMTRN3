...
slug: "model-eval/reference/output-artifacts.html"
...
- [Configuration Reference](/config-schema) for the YAML keys that influence what is written.

- [Tasks Catalog](/benchmarks-catalog) for task identifiers.
