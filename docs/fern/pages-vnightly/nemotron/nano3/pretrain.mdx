...
slug: "nemotron/nano3/pretrain.html"
description: "This stage trains the base Nemotron 3 Nano model from scratch on 25 trillion tokens using Megatron-Bridge."
---

This stage trains the base Nemotron 3 Nano model from scratch on 25 trillion tokens using [Megatron-Bridge](/../nvidia-stack#megatron-bridge).
...
The `data_prep.py` script tokenizes raw text datasets into Megatron’s binary format. See [Data Preparation Module](/../data-prep) for detailed documentation.
...
The output is registered as a [W&B Artifact](/../artifacts) (`PretrainBlendsArtifact-<config_name>`) for lineage tracking.
...
| --- | --- | --- |
| [Megatron-Core](/../nvidia-stack#megatron-core) | Distributed training primitives (TP, PP, DP, EP, CP, SP) | [GitHub](https://github.com/NVIDIA/Megatron-LM) |
| [Megatron-Bridge](/../nvidia-stack#megatron-bridge) | Model definitions, training loop, checkpoint management | [Docs](https://docs.nvidia.com/nemo/megatron-bridge/latest/) |
...
> For parallelism concepts, see [NVIDIA AI Stack: Parallelism](/../nvidia-stack#parallelism-strategies).
...
After pretraining completes, proceed to [Stage 1: SFT](/sft) for instruction tuning.
...
- [NVIDIA AI Stack](/../nvidia-stack) – Megatron-Core, Megatron-Bridge
