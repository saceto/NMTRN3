...
> **Current notes** (also summarized in the [family README](/README#current-limitations)):
...
> **See [data-prep.md](/rl/data-prep)** for the full data-prep guide:
...
| --- | --- | --- |
| [NeMo-RL](/../nvidia-stack#nemo-rl) | RL trainers and launch scripts | [Docs](https://docs.nvidia.com/nemo/rl/latest/) |
| [Ray](https://ray.io/) | Distributed execution for RL and data prep | [Docs](https://docs.ray.io/) |
| [Megatron-Core](/../nvidia-stack#megatron-core) | Distributed training backend | [GitHub](https://github.com/NVIDIA/Megatron-LM) |
...
- [RL data prep deep-dive](/rl/data-prep)
