...
slug: "nemotron/super3/quantization.html"
...
Both checkpoints are produced using [Model Optimizer](https://github.com/NVIDIA/Model-Optimizer/tree/main/examples/llm_ptq) PTQ with [Megatron-Bridge](/../nvidia-stack#megatron-bridge).
...
> **Note**: LiveCodeBench uses v6 here (vs v5 in the [post-trained model evaluations](/evaluate)), which accounts for the slightly different BF16 baselines between the two tables.
...
| --- | --- | --- |
| [Megatron-Core](/../nvidia-stack#megatron-core) | Distributed training primitives (TP, PP, EP) | [GitHub](https://github.com/NVIDIA/Megatron-LM) |
| [Megatron-Bridge](/../nvidia-stack#megatron-bridge) | PTQ quantization, checkpoint export | [Docs](https://docs.nvidia.com/nemo/megatron-bridge/latest/) |
...
- [NVIDIA AI Stack](/../nvidia-stack) — Megatron-Core, Megatron-Bridge, Transformer Engine

- [Stage 2: RL](/rl/index) — RL alignment (input to quantization)

- [Stage 4: Evaluation](/evaluate) — Benchmark evaluation
