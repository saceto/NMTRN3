...
- First run: [Generate Your First Synthetic Dataset](/getting-started)

- Adapt the pipeline to your domain: [Create a Domain Dataset for Airlines Customer Service](/how-to/create-domain-dataset)

- Preview and iterate on a config: [Tips for the Data Generation Pipeline](/how-to/run)

- Config field reference: [Config Schema](/reference/config-schema)
