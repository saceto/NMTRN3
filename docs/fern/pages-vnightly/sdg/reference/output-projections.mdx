...
slug: "sdg/reference/output-projections.html"
...
- [Config Schema](/config-schema) — Full YAML config field reference.

- [Generate Tool-Calling Data for SFT](/../how-to/tool-call-data) — Using `structured_messages` with `customer_support_tools.yaml`.

- [Generate Preference Data for DPO](/../how-to/preference-data) — Using `dpo_preference` with `rl_pref.yaml`.
