...
See [Execution Through NeMo Run](/../nemo_runspec/nemo-run) for the full profile model, attached and detached execution, and cluster setup.
...
See [Getting Started With Steps](/getting-started) for a guided tour of these commands.
...
- [Getting Started With Steps](/getting-started) walks through listing steps, inspecting inputs and outputs, and exploring the step graph from the CLI.

- [Model Training](/../train-models/index) covers supervised fine-tuning, parameter-efficient fine-tuning, RL alignment, and post-training optimization.

- [Synthetic Data Generation](/../sdg/index), [Translation](/../translation/index), [Build MCQ Benchmarks](/../build-benchmarks/index), and [Model Evaluation](/../model-eval/index) each cover one family of steps end to end.

- [Execution Through NeMo Run](/../nemo_runspec/nemo-run) describes profiles, attached and detached runs, and cluster setup.
