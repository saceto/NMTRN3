...
<CardGroup cols={2}>
<Card href="/basics" title="Nemotron Steps Basics">
...
<Card href="/getting-started" title="Getting Started With Steps">
...
<CardGroup cols={3}>
<Card href="/../sdg/index" title="Build your own dataset">
...
<Card href="/../curate/index" title="Data Curation and Preparation">
...
<Card href="/../build-benchmarks/index" title="Build your own benchmarks">
...
<Card href="/../train-models/index" title="Build your own models">
...
| Goal | Go To |
| --- | --- |
| Learn what a step, configuration, and profile are | [Nemotron Steps Basics](/basics) |
| List the available steps from the CLI | [Getting Started With Steps](/getting-started) |
| Run steps in an airgap environment | [Airgap](/airgap) |
| Curate JSONL text | [Data Curation](/../curate/index) |
| Generate synthetic training data | [Synthetic Data Generation](/../sdg/index) |
| Translate a corpus | [Translation](/../translation/index) |
| Build an MCQ benchmark | [Build MCQ Benchmarks](/../build-benchmarks/index) |
| Fine-tune or align a model | [Model Training](/../train-models/index) |
| Evaluate a model | [Model Evaluation](/../model-eval/index) |
| Set up a Lepton or Slurm environment profile | [Nemotron Steps Basics](/basics) |
