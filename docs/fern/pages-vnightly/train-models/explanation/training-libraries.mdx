...
slug: "train-models/explanation/training-libraries.html"
...
- [Training Basics](/basics) defines the training approaches and the artifact types each library consumes and produces.

- [Choose an SFT Backend](/../how-to/choose-sft-backend) compares the two SFT libraries side by side.

- [Execution through NeMo Run](/../../nemo_runspec/nemo-run) describes how each library is launched at runtime.
