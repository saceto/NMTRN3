...
slug: "train-models/reference/sft/megatron-bridge.html"
...
See the [Nemotron Steps CLI Reference](/../cli-reference) for the shared flag set.
...
- [Choose an SFT Backend](/../../how-to/choose-sft-backend) compares `sft/megatron_bridge` to `sft/automodel`.
