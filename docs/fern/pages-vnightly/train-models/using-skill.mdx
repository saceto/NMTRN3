...
slug: "train-models/using-skill.html"
...
- How your data layout lines up with what a chosen step expects, using [Data and Checkpoint Formats](/how-to/data-and-checkpoint-formats) and the step’s `step.toml` as you go.

- Backend choice inside a family, using [Choose an SFT Backend](/how-to/choose-sft-backend), [Choose a PEFT Backend](/how-to/choose-peft-backend), or [Choose an RL Alignment Step](/how-to/choose-rl-step) when you want a human-readable decision before configs land.
...
Use the [How-To Guides](/how-to/index) for task-level procedures.
Use [Reference](/reference/index) for naming and configuration conventions.
Use [Explanation](/explanation/index) for how artifacts and libraries fit together.
