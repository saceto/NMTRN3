...
slug: "translation/explanation/faith-evaluation.html"
...
See `faith_eval` in [Translation YAML Reference](/../reference/translate-config) and operational recipes in [Run FAITH Evaluation](/../how-to/run-faith-evaluation).

## Related Pages

- Where FAITH sits in the pipeline: [Pipeline Overview](/pipeline-overview)

- Input and output shapes when scores merge or filter: [Input and Output Format](/../reference/io-format)
