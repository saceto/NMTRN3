...
from nemotron.recipes.rerank.stage1_eval.eval import EvalConfig

SCRIPT_PATH = "src/nemotron/recipes/rerank/stage1_eval/eval.py"
SCRIPT_REMOTE = "src/nemotron/recipes/rerank/stage1_eval/run_uv.py"
