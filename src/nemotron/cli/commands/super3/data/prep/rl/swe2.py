...
"""SWE2 data prep command (super3 stage2_swe2 sub-stage)."""
...
SCRIPT_PATH = "src/nemotron/recipes/super3/stage2_rl/stage2_swe2/data_prep.py"
...
META = RecipeMeta(
    ...
    input_artifacts={"data": "Raw SWE-bench JSONL"},
    output_artifacts={"data": "Split train/val JSONL"},
)


def swe2(ctx: typer.Context) -> None:
    """Prepare data for SWE2 (stage2.2 — SWE-bench prompts)."""
