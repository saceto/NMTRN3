...
"""SFT command implementation for Ultra3."""
...
META = RecipeMeta(
    ...
    input_artifacts={"model": "Optional pretrained checkpoint path via checkpoint.pretrained_checkpoint/PRETRAINED_CHECKPOINT"},
...
def sft(ctx: typer.Context) -> None:
    """Run OpenMathInstruct-2 SFT with Megatron-Bridge (stage1)."""
